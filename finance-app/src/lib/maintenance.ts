...
// Благодаря этому заморозка переживает деплой PR #99 — модуль лежит и здесь.
// Снятие замка — отдельный коммит (LOCK_DEFAULT = false) и отдельный деплой,
// то есть осознанный контролируемый шаг, а не побочный эффект.
