...
export default async function CashflowPage({
  ...
  return (
    <div className="p-6 sm:p-8">
      ...
      <div className="mt-6 space-y-4">
        {ACTIVITIES.map((key) => {
          ...
          return (
            <section
              key={key}
              className="rounded-3xl bg-white p-6 ring-1 ring-slate-200/80 dark:bg-neutral-900 dark:ring-neutral-800"
            >
      ...
      <div className="mt-6 rounded-3xl bg-white p-5 ring-1 ring-slate-200/80 dark:bg-neutral-900 dark:ring-neutral-800">
